...
export default function SellerDashboard({
  ...
  useEffect(() => {
    if (loggedInUser?.readNotifications && Array.isArray(loggedInUser.readNotifications)) {
      setReadNotifications(loggedInUser.readNotifications);
    }
  }, [loggedInUser?.readNotifications]);
  ...
  const markAsRead = (id: string) => {
    ...
    if (onUpdateUser) {
      onUpdateUser({ ...loggedInUser, readNotifications: updated });
    }
  };
            ...
            >
              ...
              <form onSubmit={(e) => handleSaveProduct(e, isEditModalOpen)} className="flex-grow overflow-y-auto p-6 space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-xs font-bold text-gray-700 mb-1">বিস্তারিত বিবরণী (Detailed Description)</label>
                    <textarea
                      rows={2}
